...
Expose an item supplier lookup tool to the purchase-requisition agent so it can answer questions about which suppliers provided a given item, keyed by item code or item name.

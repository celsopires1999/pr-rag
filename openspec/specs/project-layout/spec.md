...
Separate the back-end and front-end into two independent top-level directories so each half can be owned, built, and tested on its own while shared orchestration lives at the repository root.

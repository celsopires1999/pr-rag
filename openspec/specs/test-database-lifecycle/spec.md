...
Ensure integration-test runs create a dedicated throwaway Postgres database and destroy it when the test class finishes, so no orphaned databases accumulate on the server.
